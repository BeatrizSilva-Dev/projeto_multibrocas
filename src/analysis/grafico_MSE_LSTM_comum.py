...
df = pd.read_csv("resultados_lstm_comum.csv")
...
ax.set_title("Average LSTM-AE Reconstruction Error (Microfone Comum)")
ax.legend(loc="upper left")

plt.grid(True, which="both", linestyle=":", alpha=0.3)
plt.tight_layout()

plt.savefig("lstm_mean_mse_std_comum.pdf", dpi=600, bbox_inches="tight")
plt.savefig("lstm_mean_mse_std_comum.png", dpi=300, bbox_inches="tight")
plt.show()

print("Gráfico de rampa média do LSTM-AE (Comum) gerado com sucesso!")