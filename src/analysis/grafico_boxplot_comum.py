...
def gerar_boxplot_comum_ieee():
    try:
        ...
        # Teste de Wilcoxon e Effect Size exato com aproximação estatística estável
        # Usamos o método 'approx' para extrair o zstatistic exato calculado pelo SciPy
        ...
        ax.set_xlabel('Detection Architecture (Common Mic)', fontweight='bold')
        ...
        print(f"\nBoxplot oficial audível gerado: {nome_arquivo}")
        plt.show()
