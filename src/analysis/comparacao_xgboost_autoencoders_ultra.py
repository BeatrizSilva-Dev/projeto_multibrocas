...
SAVE_PATH = r"C:\...\plots\plots_todos_testes_ultrasonic"
N_NORMAL = 5
...
for drill in lista_brocas:
    ...
    # Extração dos thresholds calculados pelo pipeline ultrassônico
    ...
    ax2.set_ylim(-0.05, 1.05) # Fornece o zoom máximo estrito para a escala linear de probabilidade
    ...
    pdf_filename = f"{drill}_ultrasonic_monitoring.pdf"
    png_filename = f"{drill}_ultrasonic_monitoring.png"
...
print(f"\nTodos os gráficos do microfone ultrassônico foram gerados e salvos em: {SAVE_PATH}")