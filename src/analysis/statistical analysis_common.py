...
path_ae = os.path.join(script_path, "results_autoencoder_common.csv")
path_xgb = os.path.join(script_path, "results_xgboost_common.csv")
path_lstm = os.path.join(script_path, "results_lstm_common.csv")
