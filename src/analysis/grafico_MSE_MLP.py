...
df = pd.read_csv("resultados_autoencoder_hibrido.csv")
...
# 2. Linha da Média dos Erros de Reconstrução
ax.plot(
    tool_life,
    mse_mean,
    color="#0d47a1",
...
ax.set_title("Average MLP-AE Reconstruction Error Across All Drills")
ax.legend(loc="upper left")

plt.grid(True, which="both", linestyle=":", alpha=0.3)
plt.tight_layout()

plt.savefig("mlp_mean_mse_std.pdf", dpi=600, bbox_inches="tight")
plt.savefig("mlp_mean_mse_std.png", dpi=300, bbox_inches="tight")
plt.show()

print("Gráfico do MLP-AE ajustado para a escala normalizada estável com sucesso!")