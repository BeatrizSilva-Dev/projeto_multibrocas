...
SAVE_PATH = r"C:\...\plots\plots_todos_testes_comum"
N_NORMAL = 5
...
for drill in lista_brocas:
    ...
    # Extração dos thresholds calculados pelo pipeline comum
    ...
    pdf_filename = f"{drill}_comum_monitoring.pdf"
    png_filename = f"{drill}_comum_monitoring.png"
...
print(f"\nTodos os gráficos do microfone comum foram gerados e salvos em: {SAVE_PATH}")