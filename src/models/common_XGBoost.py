...
common_file = "results_xgboost_common.csv"
if not os.path.exists(common_file):
    raise FileNotFoundError(f"Generate the file '{common_file}' by running the common pipeline first")

df_xgb = pd.read_csv(common_file)
