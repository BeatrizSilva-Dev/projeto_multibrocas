...
ultrasonic_file = "results_lstm_ultrasonic.csv"
...
df_lstm = pd.read_csv(ultrasonic_file)
...
fpr, tpr, _ = roc_curve(df_lstm['label'], df_lstm['score'])

df_roc = pd.DataFrame({'fpr': fpr, 'tpr': tpr})
df_roc.to_csv("ultrasonic_lstm_roc_data.csv", index=False)